  ...
  return (
    <>
      {isOpen ? (
        ...
        <div
          className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none md:w-8/12 md:m-auto xl:w-7/12 transition-all duration-200"
        >
          <div className="relative my-6 w-11/12">
            {/*content*/}
            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                  ...
                  <div className='mt-5 mb-7 w-full'>
                    {/* <form action="" autoComplete='false'> */}
                      <div className='flex flex-col justify-center items-center w-full'>
                        <div className='flex justify-center flex-col w-11/12 sm:flex-row sm:justify-between '>
                          <div className='flex flex-col justify-center mb-3 sm:w-6/12 sm:mr-2'>
                            ...
                            <input
                              ...
                              className=' border rounded pl-4 py-1.5 focus:outline-blue-300'
                              autoComplete='false'
                              value={state.name || ''}
                              required={true}
                        ...
                        <div className='flex justify-center flex-col w-11/12 md:mt-3 sm:flex-row sm:justify-between'>
                          <div className='flex flex-col justify-center mb-3 sm:w-6/12 sm:mr-2'>
                          ...
                          <div className='flex flex-col justify-start mb-3 sm:w-6/12 sm:justify-start'>
              ...
              <div className="flex items-center justify-end p-6 border-t border-solid border-slate-200 rounded-b">
                ...
                <button
                  className='text-white bg-blue-700 hover:bg-blue-900 rounded-md text-base px-4 py-1.5 transition-all duration-200'
                  type='button'
                  onClick={() => {
